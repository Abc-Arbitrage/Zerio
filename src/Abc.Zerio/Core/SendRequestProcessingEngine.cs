...
namespace Abc.Zerio.Core
{
    ...
    //         var sendCompletionProcessor = new SendCompletionProcessor2(_configuration, sendingCompletionQueue);
    //
    ...
    //     }
    //
    //     private static void ConfigureWaitStrategy(IWaitStrategy waitStrategy, UnmanagedDisruptor<SendRequestEntry> disruptor, SendCompletionProcessor2 sendCompletionProcessor)
    //     {
    //         switch (waitStrategy)
    //         {
